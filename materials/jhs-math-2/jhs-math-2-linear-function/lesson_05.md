...
式は **y＝2x＋3**。検算は、b を求めるのに**使わなかったほうの点**で——x＝4 を入れると y＝2×4＋3＝11。たしかに (4, 11) も通る。使った点 (1, 5) のほうは、その点が通るように b を決めたのだから、写しまちがいをした式でもそのまま通ってしまう——確かめの働きをするのは、使わなかった点だけだ。

なお、b を求めるとき、2つの点の**どちらを使っても同じ式になる**。(4, 11) を使うと 11＝2×4＋b で b＝3——同じだ。2点とも**同じ1本の直線の上**にある点だから、どちらで求めても、行き着く式は同じになる。計算しやすいほうの点を選んでよい。
