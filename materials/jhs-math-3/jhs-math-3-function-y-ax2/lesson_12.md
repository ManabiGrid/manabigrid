...
階段のような形のグラフになった。ここで新しい記号の約束をひとつ。線分の端の**●はその点をふくむ**、**○はふくまない**ことを表す。たとえば重さ2kgちょうどは「1kgをこえて2kgまで」の段に入るから、点(2, 600)は●（ふくむ）、点(2, 800)は○（ふくまない）。この●と○のおかげで、境目の重さでも料金がただ1つに読み取れる——つまりグラフの上でも「関数であること」が保たれている。
