...
そしてこれが、グラフの形の謎を解く。変化の割合が一定とは、xが1進むごとにyがいつも同じだけ上がる、つまりどこでも同じ傾きで進む——まっすぐ、ということだ。変化の割合が一定であることと、グラフが直線になることは、同じことの2通りの表現だった。y＝ax²は変化の割合が一定でない。**だから、グラフは直線にならず、曲線になる**。L04で「なめらかな曲線になった」と観察した事実に、これで理由が付いた。
