...
**√のまま進めるか、近似値にするかの判定規則:**

① 問題が「およそ何cm³か」のように**近似を要求したときだけ**近似値にする。要求がなければ、√のままが最終解答。
② 近似値にするときは、**必要な桁より1桁多く**まで求め、挟み撃ちでその桁がずれていないことを確かめてから答える。
...
この問題は「およそ」を求めていないから、規則①のとおり、高さ 6√2 cm・体積 18√2 π cm³ と√のままで答えてよい。
