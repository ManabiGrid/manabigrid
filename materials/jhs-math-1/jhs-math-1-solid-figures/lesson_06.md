...
ひとつ注意。円錐の立面図（三角形）の**横の辺の長さは、底面の円の直径**にあたる。そして、三角形の**斜めの辺**は、ちょうど**母線の実際の長さ**を表す（真正面から見ると、いちばん外側の母線は短く写らず、実際の長さのまま見えるからだ）。どの長さが実際のまま現れて、どの長さがそうでないか。図の種類ごとに問い直す癖をつけよう。
