...
**手順①: 文脈から定義域を決める（L07の再訪）。** 周の長さが 20cm だから、その半分が縦＋横で、縦＋横＝10（cm）。よって横の長さは 10−x cm。縦も横も正でなければならないから、x>0 かつ 10−x>0、すなわち **0<x<10**。ここは不等式を解く前に、文脈だけから決まる。
...
![単元のまとめ——2つの往復](assets/L12_fig2_round_trip_map.svg)
