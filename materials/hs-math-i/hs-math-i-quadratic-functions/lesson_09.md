...
L08では共有点が2個の場合ばかりだった。しかし放物線とx軸の位置関係は3通りある。**2点で交わる／1点で接する／共有点をもたない**。グラフが1点だけをx軸と共有するとき、グラフはx軸に**接する**といい、その点を**接点**という。感覚としては、接するグラフは1点でx軸に触れるだけで、その前後ではx軸の**同じ側**に留まる（交わる場合のように反対側へ突き抜けない）。この3通りを、方程式を解かずに**グラフの概形から**見分けるのが本レッスンの主役である。
