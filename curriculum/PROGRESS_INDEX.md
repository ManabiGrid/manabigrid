...
- 対象: 単元 437 件＋科目モジュール 42 件（診断・巻末資料・発展モジュール）
...
- [科目モジュール](#科目モジュール単元と別枠-診断巻末資料発展モジュール)
...
| `jhs-math-3-expansion-factorization--adv-01` | 中3数学「式の展開と因数分解」発展モジュール adv_01（中高一貫水準・パイロット） | 数学 | 中3 | **外部レビュー済** |
