...
- ファイル数: 488
- 集約SHA-256: `e8923823d7ff4e99fb188d0dfbb23d3b879d5266d2765f7b510cf6601d15dc48`
...
- 制作工程のパス名（パスA〜E・B2・工程⑧ 等）は上記の検疫対象**ではなく**、`docs/METHODOLOGY.md`「内部工程名との対応」の読み替え表つきで**意図的に公開している語彙**です（2026-07-17実測: 27出現・16ファイル。BUILD_LOG 2026-07-13の項に残存判断の記録あり）
